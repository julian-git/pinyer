...
insert into castell_relation (id, castell_type_id, relation_type, coeff_list, field_names, pos_list, pos_type_list, sense, rhs) values
  (1001, 1000, 'zero_or_tol', '1_1', 'total_height~total_height', '1001_1002', 'c_c', '<=', 6),
  (1002, 1000, 'zero_or_tol', '1_1', 'total_height~total_height', '1003_1004', 'm_p', '<=', 7),
  (1003, 1000, 'zero_or_tol', '1_1', 'total_height~total_height', '1004_1005', 'p_p', '<=', 5),
  (1004, 1000, 'val_tol', '1', 'weight', '1002', 'b', '<=', 65);
