...
replace into colla (id, name, city) values
  (2, "test_colla", "Barcelona/Gràcia");

replace into casteller (id, nickname, total_height, shoulder_height, axle_height, hip_height, stretched_height, shoulder_width, weight, strength)  values 
...
replace into casteller_colla values
...
replace into casteller_role values
...
replace into castell_type values 
  (1000, 2, "p4", "Pilar de 4"),
  (1001, 2, "2de8f", "Torre de vuit amb folre");

replace into castell_position (id, castell_type_id, role, is_essential, svg_id, svg_text, svg_elem, x, y, rx) values
  (1001, 1000, 'crossa', true, 1001, "Crossa 1", "circle", -50, -40, 30),
  (1002, 1000, 'crossa', true, 1002, "Crossa 2", "circle", -50, 40, 30);

replace into castell_position (id, castell_type_id, role, is_essential, svg_id, svg_text, x, y) values
  (1003, 1000, 'ma', true, 1003, "Ma 1", 0, 100),
  (1004, 1000, 'pinya', true, 1004, "Pinya 1", 0, 150),
  (1005, 1000, 'pinya', false, 1005, "Pinya 2", 0, 200);

replace into castell_relation (id, castell_type_id, relation_type, coeff_list, field_names, pos_list, sense, rhs) values
  (1001, 1000, 'zero_or_tol', '1_1', 'total_height~total_height', '1001_1002', true, 6),
  (1002, 1000, 'zero_or_tol', '1_1', 'total_height~total_height', '1003_1004', true, 7),
  (1003, 1000, 'zero_or_tol', '1_1', 'total_height~total_height', '1004_1005', true, 5),
  (1004, 1000, 'val_tol', '1', 'weight', '1002', true, 65);

replace into incompatible_castellers (id, colla_id, cast1_id, cast2_id) values 
  (1000, 2, 1016, 1018);
