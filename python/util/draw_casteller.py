...
where casteller_colla.colla_id_name = %s"""
    ...
    field_str = 'id, nickname, shoulder_height, stretched_height, shoulder_width, axle_height, hip_height'
    ...
    for (id, nickname, shoulder_height, stretched_height, shoulder_width, axle_height, hip_height) in castellers:
        ...
        fields = dict(zip(field_str.split(', '), \
                              (id, nickname, shoulder_height, stretched_height, shoulder_width, axle_height, hip_height)))
